...
<body class="bg-gray-100 font-sans leading-normal tracking-normal">
        ...
        <div class="bg-white max-w-6xl rounded-xl shadow-lg p-10 relative ml-60 transform transition-transform duration-500 hover:shadow-2xl">
            <div class="flex flex-col md:flex-row items-center gap-6">
                ...
                <div class="md:w-1/2 p-4 space-y-6">
                    ...
                    <!-- Tamaño del árbol -->
                    <div class="mt-4">
                        <label class="block text-gray-600 font-semibold">Tamaño:</label>
                    ...
                    <div class="flex space-x-6 mt-6">
                        ...
                        <button onclick="showPurchaseForm(<?= esc($tree['Id_Tree']); ?>)" class="flex items-center px-6 py-3 bg-green-500 text-white rounded-lg shadow hover:bg-green-600 focus:outline-none transition-colors duration-300 transform hover:scale-105">
                            <i class="fas fa-money-bill-wave mr-2"></i> Comprar ahora
                        </button>
                    </div>
                </div>
            </div>
    ...
    <div id="purchaseModal" class="hidden fixed inset-0 bg-gray-900 bg-opacity-50 z-50 flex justify-center items-center animate__animated animate__fadeIn">
        <div class="bg-white p-6 w-full max-w-lg max-h-[90vh] overflow-y-auto relative rounded-lg shadow-xl">
            ...
            <h1 class="text-2xl font-bold text-gray-800 text-center mb-6">Formulario de compra</h1>
            ...
            <div id="cartItems" class="space-y-6">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-800">Precio: ₡<?= number_format($tree['Price'], 2, ',', '.'); ?></p>
                    </div>
                </div>
            </div>
            ...
            <form action="<?= site_url('/friend/processPurchase'); ?>" method="POST">
                ...
                <div class="mb-4">
                    <label for="shipping_location" class="block text-gray-700 font-semibold mb-2">Ubicación de envío:</label>
                    <input type="text" id="shipping_location" name="shipping_location" required placeholder="Introduzca su dirección de envío" class="border border-gray-300 rounded-lg px-4 py-2 w-full focus:outline-none focus:ring focus:ring-blue-400">
                </div>

                <div class="mb-6">
                    <label for="payment_method" class="block text-gray-700 font-semibold mb-2">Método de pago:</label>
                ...
                <button type="submit" class="w-full py-3 bg-blue-500 text-white font-semibold rounded-lg shadow hover:bg-blue-600 transition duration-200 transform hover:scale-105">Pagar Ahora</button>
            </form>
        </div>
    </div>
</body>
