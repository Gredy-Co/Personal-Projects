    ...
    <div class="bg-white max-w-6xl rounded-xl shadow-lg p-10 relative ml-60 transform transition-transform duration-500 hover:shadow-2xl">
        ...
        <div class="flex flex-col md:flex-row items-center gap-6">
            ...
            <div class="md:w-1/2 p-4 space-y-6">
                ...
                <!-- Botón para historial del árbol -->
                <div class="mt-6">
    ...
    <div class="bg-white p-6 w-full max-w-lg max-h-[90vh] overflow-y-auto relative rounded-lg">
        ...
        <div>
            ...
            <!-- Formulario de compra -->
                ...
                <div class="mb-4">
                    <label for="shipping_location" class="block text-gray-700 font-semibold mb-2">Dirección de envío:</label>
                    <input type="text" id="shipping_location" name="shipping_location" required placeholder="Ingresa tu dirección de envío" class="border border-gray-300 rounded-lg px-4 py-2 w-full focus:outline-none focus:ring focus:ring-blue-400">
                </div>
