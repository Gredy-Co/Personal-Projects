    ...
    <div class="min-h-screen flex items-center justify-center">
        ...
        <div class="bg-white w-full max-w-7xl p-16 rounded-lg shadow-lg flex flex-col justify-between min-h-screen"> <!-- Fondo blanco ocupando toda la pantalla -->
            ...
            <div class="mb-6 ml-60">
                <h1 class="text-4xl font-bold text-gray-800">Editar Árbol</h1>
                <p class="text-gray-600 text-sm">Edite la información del árbol a continuación</p>
            </div>
            ...
            <form method="POST" action="/admin/updatetree" enctype="multipart/form-data" class="space-y-4">
                ...
                <div class="ml-60">
                    <label for="specie_id" class="block text-lg font-medium text-gray-700">Especie</label>
                    <select id="specie_id" 
                ...
                <div class="ml-60">
                    ...
                    <select id="status" 
                        ...
                        <option value="1" <?= old('status', $tree['StatusT']) == "1" ? 'selected' : '' ?>>Disponible</option>
                        <option value="0" <?= old('status', $tree['StatusT']) == "0" ? 'selected' : '' ?>>Vendido</option>
                    </select>
                ...
                <!-- Price -->
                <div class="ml-60">
                    <label for="price" class="block text-lg font-medium text-gray-700">Precio</label>
