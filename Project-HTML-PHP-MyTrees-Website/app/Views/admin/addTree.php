    ...
    <div class="min-h-screen flex items-center justify-center">
        ...
        <div class="bg-white w-full max-w-7xl p-16 rounded-lg shadow-lg flex flex-col justify-between min-h-screen"> <!-- Fondo blanco ocupando toda la pantalla -->
            ...
            <div class="mb-6 ml-60">
                <h1 class="text-4xl font-bold text-gray-800">Añadir un nuevo árbol</h1>
                <p class="text-gray-600 text-sm">Insertar los datos </p>
            </div>
            ...
            <form method="POST" action="/admin/addtree" enctype="multipart/form-data" class="space-y-4">
                ...
                <div class="ml-60">
                    ...
                    <select id="status" 
                        ...
                        <option value="0" <?= old('status') == "0" ? 'selected' : '' ?>>Vendido</option>
                    </select>
