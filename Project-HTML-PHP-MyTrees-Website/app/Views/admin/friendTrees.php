...
<div class="container mr-0 mt-10 px-4">
    ...
    <?php if (empty($trees)): ?>
        <div class="bg-blue-100 text-blue-600 text-center py-4 rounded-lg shadow-md max-w-4xl ml-80">
            ...
            <p class="mt-2 text-xl">Parece que este usuario no tiene árboles todavía.</p>
            <p class="mt-4 text-gray-600">Quizás tengan alguno pronto. ¡Estén atentos!</p>
        </div>
    <?php else: ?>
                ...
                ?>
                    ...
                    <div class="bg-white shadow-md rounded-lg overflow-hidden">
                        ...
                        <div class="p-4">
                            ...
                            <p class="text-gray-600">Ubicación: <?php echo htmlspecialchars($tree['Shipping_Location']); ?></p>
                            <!-- Display the tree's purchase date -->
                            <p class="text-gray-600">Fecha de compra: <?php echo htmlspecialchars(date('Y-m-d', strtotime($tree['Purchase_Date']))); ?></p>
                            ...
                            <div class="mt-4 flex justify-between space-x-4"> <!-- Agregamos espacio entre los botones -->
                                <?php 
                                    ...
                                    if ($roleId == 1): ?> 
                                        ...
                                        <a href="<?php echo $updateFriendTree; ?>" class="bg-yellow-500 text-white px-1 py-1 rounded text-sm hover:bg-yellow-600">Editar Árbol</a>
                                        <a href="<?php echo $registerUpdate; ?>" class="bg-green-500 text-white px-1 py-1 rounded text-sm hover:bg-green-600">Registrar Actualización</a>
                                        <a href="<?php echo $treeHistory; ?>" class="bg-green-500 text-white px-1 py-1 rounded text-sm hover:bg-green-600">Historial del árbol</a>
                                    <?php else: ?>
                                        <a href="<?php echo $registerUpdate; ?>" class="bg-green-500 text-white px-1 py-2 rounded hover:bg-green-600">Registrar Actualización</a>
                                        <a href="<?php echo $treeHistory; ?>" class="bg-green-500 text-white px-1 py-2 rounded hover:bg-green-600">Historial del árbol</a>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
