    ...
    <div class="min-h-screen flex items-center justify-center">
        ...
        <div class="bg-white w-full max-w-7xl p-16 rounded-lg shadow-lg flex flex-col justify-between min-h-screen"> <!-- Fondo blanco ocupando toda la pantalla -->
            ...
            <div class="mb-6 ml-60">
                <h1 class="text-4xl font-bold text-gray-800">Editar Especies</h1>
                <p class="text-gray-600 text-sm">Edite la información de la especie a continuación</p>
            </div>
            ...
            <form method="POST" action="/admin/updatespecies" class="space-y-4">
                ...
                <!-- Commercial Name -->
                <div class="ml-60">
                    <label for="commercial_name" class="block text-lg font-medium text-gray-700">Nombre Comercial</label>
                ...
                <!-- Scientific Name -->
                <div class="ml-60">
                    <label for="scientific_name" class="block text-lg font-medium text-gray-700">Nombre Científico</label>
