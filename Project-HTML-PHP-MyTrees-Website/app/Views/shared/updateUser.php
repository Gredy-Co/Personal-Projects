    ...
    <div class="min-h-screen flex items-center justify-center py-16 px-4 ml-60">
        ...
        <div class="bg-white w-full max-w-3xl p-12 rounded-2xl shadow-xl">
            ...
            <div class="mb-8 text-center">
                <h1 class="text-4xl font-bold text-gray-800">Actualiza tu perfil</h1>
                <p class="text-gray-600 text-lg mt-2">Asegúrese de que sus datos estén actualizados para disfrutar de una experiencia personalizada</p>
            </div>
            ...
            <form method="POST" action="/updateuser" enctype="multipart/form-data" class="space-y-8">
                ...
                <div class="space-y-6">
                    <!-- First Name -->
                    <div class="relative">
                        <label for="first_name" class="text-lg font-medium text-gray-700">Nombre</label>
                    ...
                    <!-- Last Name 1 -->
                    <div class="relative">
                        <label for="last_name1" class="text-lg font-medium text-gray-700">Primer Apellido</label>
                    ...
                    <!-- Last Name 2 -->
                    <div class="relative">
                        <label for="last_name2" class="text-lg font-medium text-gray-700">Segundo Apellido</label>
                    ...
                    <!-- Phone -->
                    <div class="relative">
                        <label for="phone" class="text-lg font-medium text-gray-700">Teléfono</label>
                    ...
                    <!-- Gender -->
                    <div class="relative">
                        <label for="gender" class="text-lg font-medium text-gray-700">Género</label>
