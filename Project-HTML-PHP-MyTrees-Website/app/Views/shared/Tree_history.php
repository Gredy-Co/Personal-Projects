...
<div x-data="{ showModal: false, modalImage: '' }" class="container mx-auto mt-10 text-center px-4" @keydown.window.escape="showModal = false">
    ...
    <div class="bg-white shadow-lg rounded-lg p-6 max-w-4xl ml-80">
        <div class="text-center">
            <h1 class="text-5xl font-bold text-gray-800">Actualizaciones de árboles</h1>
            <p class="text-gray-600 mt-2 text-xl">Aquí hay una lista de todas las actualizaciones para el árbol seleccionado.</p>
        </div>
    </div>
        ...
        <table class="min-w-full bg-white shadow-md rounded-lg overflow-hidden w-full">
            <thead>
                <tr class="bg-blue-100 text-gray-800">
                    <th scope="col" class="px-6 py-3 text-center">Imagen de árbol</th>
            ...
            <?php else : ?>
                <tr>
                    <td colspan="4" class="text-center text-gray-500 py-4">No se encontraron actualizaciones</td>
                </tr>
            <?php endif; ?>
            </tbody>
        </table>
